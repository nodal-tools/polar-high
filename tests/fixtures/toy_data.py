...
def make_toy_data() -> ToyData:
    ...
    return ToyData(
        ...
        avail      = Param(("t",), pl.DataFrame({"t": ["t1","t2","t3","t4"],
                                                  "value": [50.0, 30.0, 80.0, 20.0]})),
        demand     = Param(("t",), pl.DataFrame({"t": ["t1","t2","t3","t4"],
                                                  "value": [60.0, 90.0, 70.0, 80.0]})),
        ...
        max_total     = Param(("p",), pl.DataFrame({"p": ["gas", "wind"],
                                                     "value": [150.0, 200.0]})),
    )
