...
def _write_lp_to_mps(tmp_path) -> str:
...
def test_highs_wrapper_mps_readback(tmp_path) -> None:
    ...
    """
    mps_path = _write_lp_to_mps(tmp_path)
    h = highspy.Highs()
    try:
...
def test_gurobi_wrapper_mps_readback(tmp_path) -> None:
...
def test_cplex_wrapper_mps_readback(tmp_path) -> None:
...
def test_xpress_wrapper_mps_readback(tmp_path) -> None:
