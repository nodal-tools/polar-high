...
polar-high build path against the earlier GNU MathProg one across
...
Issue tracker:
[github.com/nodal-tools/polar-high/issues](https://github.com/nodal-tools/polar-high/issues).

Please include:

- the polar-high version (`pip show polar-high`),
